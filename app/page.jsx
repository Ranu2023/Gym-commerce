        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-gray-200 max-w-3xl mx-auto">
              Premium gym supplements to help you achieve your fitness goals.
              Quality products, expert guidance, and fast delivery.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Most popular supplements among our customers
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                About GymSupplements
              </h2>
              <p className="text-lg text-gray-300 mb-6">
                We're passionate about helping fitness enthusiasts achieve their
                goals through premium quality supplements. With over 10 years of
                experience in the industry, we've built a reputation for
                excellence and trust.
              </p>
              <p className="text-lg text-gray-300 mb-8">
                Our team of experts carefully selects each product to ensure you
                get the best results from your training. From protein powders to
                pre-workouts, we have everything you need to fuel your fitness
                journey.
              </p>
