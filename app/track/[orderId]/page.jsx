...
//   const { order, events, estimatedDelivery, currentLocation, deliveryAgent } =
//     trackingData;
...
//                 {getStatusIcon(order.status, true, false)}
//               </div>
//               <div>
...
//                           {formatDateTime(event.timestamp.toString())}
//                         </p>
//                       </div>
//                       {event.location && (
...
//                         <a
//                           href={`mailto:${deliveryAgent.email}`}
//                           className="hover:text-blue-600"
//                         >
//                           {deliveryAgent.email}
//                         </a>
...
//                   {" "}
//                   {`${order.shippingAddress.fullName}, ${order.shippingAddress.address}, ${order.shippingAddress.city}, ${order.shippingAddress.state}, ${order.shippingAddress.pincode} | Phone: ${order.shippingAddress.phone}`}
//                 </p>
//               </div>
//             </div>
...
export default function OrderTrackingPage() {
  ...
  useEffect(() => {
    if (params.orderId) {
      fetchTrackingDetails(params.orderId);
    }
  }, [params.orderId]);
